  ...
  <div class="food" v-show="showFlag" ref="food">
    <div class="food-content">
      ...
      <div class="rating">
        ...
        <ratingselect :selectedType="selectedType" :onlyContent="onlyContent" :desc="desc" :ratings="food.ratings" @toggleOnlyContent="toggleOnlyContent" @selectRatingType="selectRatingType" ref="ratingselect"></ratingselect>
